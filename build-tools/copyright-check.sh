...
CHECK2=" Copyright IBM Corporation 2016, 2018. All Rights Reserved."
#LINE3="${COMMENT_PREFIX}Note to U.S. Government Users Restricted Rights:"
CHECK3=" US Government Users Restricted Rights -"
...
#LIC_ARY to scan for
LIC_ARY=("$CHECK1" "$CHECK2" "$CHECK3" "$CHECK4" "$CHECK6")
